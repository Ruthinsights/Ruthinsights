...
* Creating analysis ready for visualization and reporting
* Data cleaning and preprocessing large datasets
* Creating joins, Cte, views, stored procedures and aggregating data
## Python
* Data cleaning, transformation and manipulation using pandas
* Data visualization with Matplotlib, seaborn and Plotly
* Automating tasks and workflows using python scripts
* Statistical analysis and trend detection
## Power BI
* Designing interactive dashboards and reports
* Creatng KPI, key metrics and visual storytelling
